...
var base = new Airtable({ apiKey: "keygfbxPOskMJ40tx" }).base(
  "appRWHsDgel1bAQvi"
);
...
function setTable(allItems) {
  ...
  document.body.appendChild(container); // append that container to body tag //
  ...
  allItems.forEach(function(item) {
    ...
    //column names should have underscores, no cap, call each column (ex.images/pdfs/etc) //
    //0 stands for one...first item in array//
